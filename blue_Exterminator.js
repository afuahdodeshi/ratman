export default class blue_Exterminator {
    constructor(blue_Exterminator) {
      this.size = 10;
      this.x = 630; // Starting position
      this.y = 870;
      this.blue_Exterminator = blue_Exterminator;
    ...
    show() {
      image(this.blue_Exterminator, this.x, this.y, 70, 90);
    }
  }
